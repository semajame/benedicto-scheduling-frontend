...
export class bshrmfirstEnlistmentComponent implements AfterViewInit {
  schedule: schedule[] = [];
  ...
  ngAfterViewInit(): void {
    forkJoin({
      schedules: this.cbmService.getFirstBshrmSchedules(),
      minorSubjects: this.cbmService.findMinorSubjectsBshrmFirstYear(),
