...
export class bshrmthirdEnlistmentComponent implements AfterViewInit {
  schedule: schedule[] = [];
  ...
  ngAfterViewInit(): void {
    forkJoin({
      schedules: this.cbmService.getThirdBshrmSchedules(),
      minorSubjects: this.cbmService.findMinorSubjectsBshrmThirdYear(),
