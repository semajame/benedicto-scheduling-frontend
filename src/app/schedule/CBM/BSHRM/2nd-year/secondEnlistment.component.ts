...
export class bshrmsecondEnlistmentComponent implements AfterViewInit {
  schedule: schedule[] = [];
  ...
  ngAfterViewInit(): void {
    forkJoin({
      schedules: this.cbmService.getSecondBshrmSchedules(),
      minorSubjects: this.cbmService.findMinorSubjectsBshrmSecondYear(),
