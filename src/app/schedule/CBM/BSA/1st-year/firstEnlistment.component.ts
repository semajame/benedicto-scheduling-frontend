...
export class bsafirstEnlistmentComponent implements AfterViewInit {
  schedule: schedule[] = [];
  ...
  ngAfterViewInit(): void {
    forkJoin({
      schedules: this.cbmService.getFirstBsaSchedules(),
      minorSubjects: this.cbmService.findMinorSubjectsBsaFirstYear(),
