...
export class bsafourthEnlistmentComponent implements AfterViewInit {
  schedule: schedule[] = [];
  ...
  ngAfterViewInit(): void {
    forkJoin({
      schedules: this.cbmService.getFourthBsaSchedules(),
      minorSubjects: this.cbmService.findMinorSubjectsBsaFourthYear(),
