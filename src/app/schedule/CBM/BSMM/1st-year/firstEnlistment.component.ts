...
export class bsmmfirstEnlistmentComponent implements AfterViewInit {
  schedule: schedule[] = [];
  ...
  ngAfterViewInit(): void {
    forkJoin({
      schedules: this.cbmService.getFirstBsmmSchedules(),
      minorSubjects: this.cbmService.findMinorSubjectsBsmmFirstYear(),
