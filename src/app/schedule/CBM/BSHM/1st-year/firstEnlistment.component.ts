...
export class bshmfirstEnlistmentComponent implements AfterViewInit {
  schedule: schedule[] = [];
  ...
  ngAfterViewInit(): void {
    forkJoin({
      schedules: this.cbmService.getFirstBshmSchedules(),
      minorSubjects: this.cbmService.findMinorSubjectsBshmFirstYear(),
