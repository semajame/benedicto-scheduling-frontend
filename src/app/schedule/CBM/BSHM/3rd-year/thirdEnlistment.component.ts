...
export class bshmthirdEnlistmentComponent implements AfterViewInit {
  schedule: schedule[] = [];
  ...
  ngAfterViewInit(): void {
    forkJoin({
      schedules: this.cbmService.getThirdBshmSchedules(),
      minorSubjects: this.cbmService.findMinorSubjectsBshmThirdYear(),
