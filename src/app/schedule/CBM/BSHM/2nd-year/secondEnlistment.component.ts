...
export class bshmsecondEnlistmentComponent implements AfterViewInit {
  schedule: schedule[] = [];
  ...
  ngAfterViewInit(): void {
    forkJoin({
      schedules: this.cbmService.getSecondBshmSchedules(),
      minorSubjects: this.cbmService.findMinorSubjectsBshmSecondYear(),
