...
export class bsiefirstEnlistmentComponent implements AfterViewInit {
  schedule: schedule[] = [];
  ...
  ngAfterViewInit(): void {
    forkJoin({
      schedules: this.coeService.getFirstBsieSchedules(),
      minorSubjects: this.coeService.findMinorSubjectsBsieFirstYear(),
