...
export class bsmesecondEnlistmentComponent implements AfterViewInit {
  schedule: schedule[] = [];
  ...
  ngAfterViewInit(): void {
    forkJoin({
      schedules: this.coeService.getSecondBsmeSchedules(),
      technoSubject: this.ccsService.findTechnoForCoe(),
      minorSubjects: this.coeService.findMinorSubjectsBsmeSecondYear(),
