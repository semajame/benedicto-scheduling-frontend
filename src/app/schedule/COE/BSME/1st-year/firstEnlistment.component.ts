...
export class bsmefirstEnlistmentComponent implements AfterViewInit {
  schedule: schedule[] = [];
  ...
  ngAfterViewInit(): void {
    forkJoin({
      schedules: this.coeService.getFirstBsmeSchedules(),
      minorSubjects: this.coeService.findMinorSubjectsBsmeFirstYear(),
