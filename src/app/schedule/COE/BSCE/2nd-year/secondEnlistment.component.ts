...
export class bscesecondEnlistmentComponent implements AfterViewInit {
  schedule: schedule[] = [];
  ...
  ngAfterViewInit(): void {
    forkJoin({
      schedules: this.coeService.getSecondBsceSchedules(),
      technoSubject: this.ccsService.findTechnoForCoe(),
      minorSubjects: this.coeService.findMinorSubjectsBsceSecondYear(),
